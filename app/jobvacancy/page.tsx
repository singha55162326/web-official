import Jobannouce from '@/components/Jobannouce'
...
<div className="flex items-center justify-center bg-cover bg-center h-screen" style={{ backgroundImage: 'url("/images/Group 179.png")', filter: 'blur(0)' }}>
  <div className="text-center text-white">
    <h1 className="relative font-bold ">ປະກາດສະໝັກວຽກ</h1>
  ...
  <div className=" text-xl relative leading-[57.6px]">ປະກາດສະໝັກວຽກ</div>
</div>
