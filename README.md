...
```
cd existing_repo
git remote add origin https://gitlab.edl.com.la/front-end/web-official.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.edl.com.la/front-end/web-official/-/settings/integrations)
